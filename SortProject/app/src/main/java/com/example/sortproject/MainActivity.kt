...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val names14 = intArrayOf(1, 10, 9, 7, 3, 0)
...
//        PancakeSort(names13)
        ...
        println("Before sorting : ${names14.contentToString()}")
        bogo_sort(names14)
        println("After sorting  : ${names14.contentToString()}")
    }
...
fun shuffle(a: IntArray) {
    ...
    for (i in 0 until n) {
        val t = a[i]
        var r = rand.nextInt(RAND_MAX) % n
        a[i] = a[r]
        a[r] = t
    }
}

fun bogo_sort(a: IntArray) {
